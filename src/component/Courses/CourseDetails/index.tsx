...
const CourseDetails: React.FC = () => {
  const navigate = useNavigate()
    ...
    return (
        <div>
            <Navbar/>
            <div className="flex gap-[30px] pt-[72px] pl-[80px] flex-wrap max-sm:pl-[2px] md:pt-[110px] md:pl-1 sm:pl-4 sm:pr-4 sm:pt-[130px] max-w-full">
            <div >
            <div className="pb-[48px] max-sm:pb-[32px]" >
                <h1 className="pb-[40px] text-[48px] max-sm:text-[28px] max-sm:w-[236px]" style={{fontFamily:'Helvetica', fontWeight:'500', color:'rgba(174, 75, 254, 1)'}}>
                Basics of UI/UX designing
                </h1>
                <img src={CourseImg} className="w-[756px] h-[453px] max-sm:w-[343px] max-sm:h-[206px] cursor-pointer" onClick={()=>navigate('/Courses/details/video')}/>
            </div>
            <div className="w-[756px] max-sm:w-[343px] rounded-[10px] pt-[28px] pl-[28px] pr-[28px] pb-[5px] mb-[48px]
            max-sm:pt-[13px] max-sm:pl-[16px] max-sm:pr-[9px] max-sm:pb-[33px]" style={{border:'1px solid rgba(30, 30, 30, 0.3)'}}>
                <h2 className="text-[32px] mb-[24px] max-sm:mb-[16px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(174, 75, 254, 1)'}}>Description.</h2>
            ...
            <div className="w-[756px] rounded-[10px] py-[32px] px-[28px] max-sm:w-[343px] max-sm:pl-[12px] max-sm:pr-[16px] max-sm:py-[18px]" style={{border: '1px solid rgba(30, 30, 30, 0.3)'}}>
                <h2 className="text-[32px] mb-[28px] max-sm:text-[22px] max-sm:mb-[15px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(174, 75, 254, 1)'}}>What you’ll learn</h2>
                <div className="flex items-center gap-[14px] max-sm:gap-[4px]">
                    <img src={Tic1} width={40} height={40} className="max-sm:w-[23px] max-sm:h-[23px]"/>
                    <p className="text-[24px] max-sm:text-[16px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(35, 45, 79, 0.9)'}}> The principles of User Interface Design and Prototyping </p>
                </div>
                <div className="flex items-center gap-[14px] pt-[24px]  max-sm:gap-[4px]">
                    <img src={Tic2} width={40} height={40} className="max-sm:w-[23px] max-sm:h-[23px]"/>
                    <p className="text-[24px] max-sm:text-[16px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(35, 45, 79, 0.9)'}}> The basics of Human-computer Intera </p>
                </div>
                <div className="flex items-center gap-[14px] pt-[24px] max-sm:gap-[4px]">
                    <img src={Tic3} width={40} height={40} className="max-sm:w-[23px] max-sm:h-[23px]"/>
                    <p className="text-[24px] max-sm:text-[16px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(35, 45, 79, 0.9)'}}> How to read a User Flow Diagram</p>
                </div>
                <div className="flex items-center gap-[14px] pt-[24px] max-sm:gap-[4px]">
                    <img src={Tic4} width={40} height={40}  className="max-sm:w-[23px] max-sm:h-[23px]"/>
                    <p className="text-[24px] max-sm:text-[16px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(35, 45, 79, 0.9)'}}> How tu use Figma and its given tools</p>
                </div>
                <div className="flex items-center gap-[14px] pt-[24px] max-sm:gap-[4px]">
                    <img src={Tic5} width={40} height={40} className="max-sm:w-[23px] max-sm:h-[23px]"/>
                    <p className="text-[24px] max-sm:text-[16px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(35, 45, 79, 0.9)'}}>How to design within Figma</p>
                </div>
            </div>
            <div className="w-[756px] rounded-[10px] mt-[48px] pt-[36px] pb-[20px] pl-[28px] pr-[9px] max-sm:w-[343px] max-sm:rounded-[4px] max-sm:pl-[12px] max-sm:pt-[18px] max-sm:mt-[32px]" style={{border: '1px solid rgba(30, 30, 30, 0.3)'}}>
                <h2 className="text-[32px] mb-[28px] max-sm:text-[26px]" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(174, 75, 254, 1)'}}>About the instructor</h2>
                    <div>
                        <div  className="flex items-center gap-[36px] pb-[38px] max-sm:gap-[16px] max-sm:pb-[30px]">
                            <img src={TeacherComment} width={120} height={120} className="rounded-full max-sm:w-[55px] max-sm:h-[55px]"/>
                            <div>
                                <h2 className="text-[26px] pb-[3px] max-sm:text-[16px] max-sm:pb-0" style={{fontFamily:'Helvetica', fontWeight:'500', color:'rgba(35, 45, 79, 1)'}}>Warren Daniel</h2>
                                <p className="text-[26px] pb-[8px] max-sm:text-[16px] max-sm:pb-0" style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(35, 45, 79, 0.6)'}}>UI/UX designer</p>
                        ...
                        <div className="pb-[38px] max-sm:pb-[30px]">
                            <p className="text-[24px] pb-[18px] max-sm:text-[16px] max-sm:pb-[14px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>UI/UX Designer,with 7+ Years Experience Guarantee of High Quality Work.</p>
                            <p className="text-[24px] max-sm:text-[16px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>Cursus blandit sit id pellentesque urna. Purus elit malesuada nisl integer gravida. Viverra in faucibus fames a ipsum ipsum pulvinar maecenas. Sagittis tortor quisque lorem nunc nunc sem quisque rhoncus morbi. Ultricies proin morbi sed sagittis quam. </p>
                        </div>
                        <div>
                            <h2 className="text-[24px] pb-[16px] max-sm:text-[16px] max-sm:pb-[12px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>Available for</h2>
                            <p className="text-[24px] pb-[10px] max-sm:text-[16px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>1.Full Time Office Work</p>  
                            <p className="text-[24px] pb-[10px] max-sm:text-[16px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>2.Remote Work</p>  
                            <p className="text-[24px] pb-[10px] max-sm:text-[16px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>3.Freelance</p>  
                            <p className="text-[24px] pb-[10px] max-sm:text-[16px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>4.Contact</p>  
                            <p className="text-[24px] pb-[10px] max-sm:text-[16px]"  style={{fontFamily:'Helvetica', fontWeight:'400', color:'rgba(0, 0, 0, 0.7)'}}>5.Worldwide</p>  
                        </div>
                    </div>
            </div>
            </div>
            <div className="flex flex-col rounded-[10px] h-[503px] pt-[28px] pb-[23px] px-[36px] mt-[88px] 
            max-sm:w-[343px] max-sm:h-[472px] max-sm:px-[24px] max-sm:pb-[22px] max-sm:mt-[32px] max-sm:mb-[64px]" style={{border: '1px solid rgba(30, 30, 30, 0.3)'}}>
                ...
                <button className="flex items-center border-none outline-none py-[13px] px-[147px] rounded-[5px] gap-[12px] w-[422px] 
                ...
                <button className="flex items-center outline-none py-[13px] pl-[140px] rounded-[5px] gap-[12px] w-[422px] mt-[18px] 
